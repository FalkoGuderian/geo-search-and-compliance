...
| 🏛️ Gemeinden                                                                                                                                                                                     |  🌊 Flüsse und Bäche                                                                                                                                                            |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Suchanfrage:** "Gemeinden in 20 km um Dresden" <br>**Beschreibung:** Darstellung aller Gemeinden (vg250:vg250_gem) im 20km-Radius um Dresden-Mitte mit Grenzvisualisierungen | **Suchanfrage:** "Flüsse und Bäche in Dresden" <br>**Beschreibung:** Anzeige aller Fließgewässer (Watercourse) im Stadtgebiet Dresden mit Wasserkartierung |
...
| 🏞️ Seen                                                                                                                                                       |  🚉 Bahnhöfe                                                                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Suchanfrage:** "Seen im Großraum Leipzig" <br>**Beschreibung:** Zeigt alle stehenden Gewässer (StandingWater) im 50km-Radius um Leipzig | **Suchanfrage:** "Bahnhöfe in Freital" <br>**Beschreibung:** Anzeige aller Bahnhofs-Knoten im Stadtgebiet Freital mit interaktiven Popups und Lagebezügen |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Suchanfrage:** "Wo sind Vögel in Dresden und Umgebung geschützt" <br>**Beschreibung:** Anzeige aller Vogelschutzgebiete in Dresden und Umgebung mit detaillierten Schutzgebietsinformationen | **Suchanfrage:** "Naturschutzgebiete 10000m von der Stadtmitte Dresden entfernt" <br>**Beschreibung:** Visualisiert alle Naturschutzgebiete innerhalb 10km von Dresden-Mitte |
...
| ✈️ Flugplätze                                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Suchanfrage:** "Flugplätze im Großraum Leipzig, Chemnitz und Dresden" <br>**Beschreibung:** Visualisiert alle Flugplätze (AerodromeArea) im Mehrstadtbereich |
